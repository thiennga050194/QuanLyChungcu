...
import com.example.quanlychungcu.service.TienNuocService;
...
@RestController
@RequestMapping("/api/tien/nuoc")
public class TienNuocController {

    @Autowired
    private TienNuocService service;
    ...
    @GetMapping("/paged")
    public ResponseEntity<Page<TienNuocDTO>> getPaged(
    ...
    public List<TienNuocDTO> getByMaCuDan(@PathVariable String maCuDan) {
        return service.getByMaCuDan(maCuDan);
    }

    @GetMapping("/ngay/{ngayThu}")
    public List<TienNuocDTO> getByNgayThu(@PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate ngayThu) {
        return service.getByNgayThu(ngayThu);
    }

    @GetMapping("/thang/{year}/{month}")
    public List<TienNuocDTO> getByMonth(
    ...
    public List<TienNuocDTO> getByTrangThai(@PathVariable boolean trangThai) {
        return service.getByTrangThai(trangThai);
    }

    @GetMapping("/top/{year}/{month}")
    public List<TienNuocDTO> getTopByMonth(
            @PathVariable int year,
            @PathVariable int month,
    ...
    @PostMapping
    public ResponseEntity<?> create(@RequestBody @NonNull TienNuocDTO dto) {
        try {
            TienNuocDTO created = service.create(dto);
    ...
    public ResponseEntity<?> update(
            ...
            @RequestBody @NonNull TienNuocDTO dto) {
        try {
            TienNuocDTO updated = service.update(maCuDan, maCanHo, ngayThu, dto);
